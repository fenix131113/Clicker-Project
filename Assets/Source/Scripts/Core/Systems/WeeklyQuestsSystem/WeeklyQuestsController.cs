...
public class WeeklyQuestsController : MonoBehaviour
{
    ...
    private void GenerateAllQuests()
    {
        _allQuests = new()
        {
            new ClickerWeeklyQuest("Кликов", this, new WeeklyQuestDifficultItem[]{ new(1, 75, 0, 75), new(1, 125, 0, 125), new(1, 0, 1, 175), new(2, 75, 0, 150), new(2, 125, 0, 200), new(2, 0, 1, 275),  new(3, 75, 0, 250), new(3, 125, 0, 350), new(3, 0, 1, 450), new(4, 75, 0, 375), new(4, 125, 0, 500), new(4, 0, 1, 650),  new(5, 75, 0, 525), new(5, 125, 0, 675), new(5, 0, 1, 800), new(6, 75, 0, 700), new(6, 125, 0, 850), new(6, 0, 1, 1000), new(7, 75, 0, 875), new(7, 125, 0, 1000), new(7, 0, 1, 1200),}, _objectsContainer.ClickerScript),
            new FoodCookingWeeklyQuest("Приготовить еды", this, new WeeklyQuestDifficultItem[]{ new(1, 100, 0, 10), new(1, 150, 0, 15), new(1, 0, 1, 25), new(2, 100, 0, 20), new(2, 150, 0, 35), new(2, 0, 1, 55),  new(3, 100, 0, 40), new(3, 150, 0, 65), new(3, 0, 1, 90), new(4, 100, 0, 90), new(4, 150, 0, 120), new(4, 0, 1, 150),  new(5, 100, 0, 120), new(5, 150, 0, 150), new(5, 0, 1, 185), new(6, 100, 0, 150), new(6, 150, 0, 180), new(6, 0, 1, 225), new(7, 100, 0, 180), new(7, 150, 0, 250), new(7, 0, 1, 300),}, _objectsContainer.ClickerScript),
            new EarnMoneyWeeklyQuest("Заработать денег", this, new WeeklyQuestDifficultItem[]{ new(1, 100, 0, 15), new(1, 150, 0, 25), new(1, 0, 1, 40), new(2, 100, 0, 30), new(2, 150, 0, 50), new(2, 0, 1, 80),  new(3, 100, 0, 50), new(3, 150, 0, 90), new(3, 0, 1, 130), new(4, 100, 0, 90), new(4, 150, 0, 130), new(4, 0, 1, 180),  new(5, 100, 0, 130), new(5, 150, 0, 180), new(5, 0, 1, 230), new(6, 100, 0, 180), new(6, 150, 0, 250), new(6, 0, 1, 300), new(7, 100, 0, 230), new(7, 150, 0, 300), new(7, 0, 1, 400),}),
        };
    }
